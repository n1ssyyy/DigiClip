...
return [
     ...
     */
    'version' => env('NATIVEPHP_APP_VERSION', '1.0.17'),
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.digiclip.app'),
     ...
     * nativephp://some/path
     */
    'deeplink_scheme' => env('NATIVEPHP_DEEPLINK_SCHEME', 'digiclip'),
     ...
     */
    'website' => env('NATIVEPHP_APP_WEBSITE', 'https://github.com/n1ssyyy/DigiClip'),
