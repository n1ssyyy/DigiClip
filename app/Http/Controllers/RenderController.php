...
class RenderController extends Controller
{
    ...
    /** Inline stream for the in-app player.
     *
     *  response()->file() (BinaryFileResponse) already parses Range headers,
     *  answers 206 with Content-Range, and streams from disk — no manual
     *  range handling needed (a previous hand-rolled StreamedResponse wrote
     *  the wrong body size and crashed via Response::setCallback). */
