    ...
    },
    {
        ...
        body: () => (
            <p>
                ...
                into the upload box, top left. MP4, MOV, MKV or WebM, straight off
                your disk. It lands in the <span className="font-medium text-foreground">Queue</span> right below.
            </p>
        ),
    },
    {
        ...
        body: () => (
            <p>
                ...
                <span className="font-mono text-[11px]">Upload → Audio → Script → Clips</span>.
                Retry or cancel anytime — the row tells you what is happening.
            </p>
        ),
    },
    {
